    ...
    <div>
        <nav class="flex" aria-label="Breadcrumb">
            <ol class="flex items-center space-x-2">
                ...
                <li class="text-gray-900 font-medium">Add New Book</li>
            </ol>
        </nav>
        <h1 class="mt-2 text-2xl font-bold text-gray-900">Add New Book</h1>
    </div>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-500">
                            Don't see the author? <a href="{{ route('authors.create') }}" class="text-primary-600 hover:text-primary-900">Add new author</a>
                        </p>
                    </div>
